...
class ViewController: UIViewController {
    ...
    func setupBeaconDetails() {
        beaconManager.createBeaconRegion(majorIndex: Int(K.major), minorIndex: Int(K.minor))
        uuid.text          = K.uuid
    ...
    @IBAction func pickedSelectors(_ sender: UISegmentedControl) {
        beaconManager.createBeaconRegion(majorIndex: segmentMajor.selectedSegmentIndex + 1,
                                         minorIndex: segmentMinor.selectedSegmentIndex + 1)
