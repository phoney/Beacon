...
//    static let uuid                       = "AF80D50E-9905-4562-B154-AB5C82B635ED"  // generated using uuidgen
    ...
    static let uuid = "21ad053d-0d9f-4b55-a1d6-e76b8fcd1966"
    static let beaconID                   = "Flexible iOS Beacon"  // any string
    static let major : CLBeaconMajorValue = 100 // any unsigned integer (UInt16)
    static let minor : CLBeaconMinorValue = 20  // any unsigned integer (UInt16)
